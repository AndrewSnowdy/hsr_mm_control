...
class HSRPersonTracker(Node):
    def __init__(self):
        ...
        self.class_configs = {
            ...
            "prox_button": {"thresh": 25, "dist": 0.5, "timeout": 20.0, "color": (1.0, 0.5, 0.0)}, # Orange
            "push_button": {"thresh": 12, "dist": 0.5, "timeout": 10.0, "color": (0.0, 1.0, 0.0)}, # Green
            "door":        {"thresh": 48,  "dist": 0.5, "timeout": 75.0,  "color": (1.0, 0.0, 0.0)}, # Red
            "bottle":      {"thresh": 2,  "dist": 0.4, "timeout": 4.0,  "color": (1.0, 1.0, 0.0)}, # Yellow
